...
class SpecialtyAdmin(admin.ModelAdmin):
    ...
    def practitioner_count(self, obj):
        return obj.practitioner_set.count()
    practitioner_count.short_description = 'Practitioners'

class PractitionerAdmin(admin.ModelAdmin):
    list_display = ('user_email', 'user_name', 'city', 'specialties_list', 'hourly_rate', 'currency', 'is_verified')
...
admin.site.index_title = "Welcome to NutriConnect Admin"
